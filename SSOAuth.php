<?php
class SSOAuth extends AuthPluginBase {

    protected $storage = 'DbStorage';
    static protected $description = 'SSO Auth';
    static protected $name = 'SSOAuth';
    public $mail = '';
    public $displayName = '';
    ...
    public function beforeLogin() {
		// Do nothing if this user is not SSOAuth type
		
		$request = $this->api->getRequest();		
		$authMethod = $request->getParam('authMethod');
		if ($authMethod != 'SSOAuth') 
		{
			return;
		}
